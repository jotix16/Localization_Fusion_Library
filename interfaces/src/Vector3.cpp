...
std::size_t Vector3::serialize(void *pOutput) const
{
    if (!pOutput)
        return 0;
...
std::size_t Vector3::deserialize(const void *pInput)
{
    if (!pInput)
        return 0;
...
Vector3::Vector3(const geometry_msgs::msg::Vector3 &other)
{
...
std::size_t Vector3::getSerializedSize() const
{
	std::size_t _size_ = 0;
...
geometry_msgs::msg::Vector3& Vector3::operator=(const geometry_msgs::msg::Vector3 &other)
{
    if (this != &other)
    {
        x = other.x;
